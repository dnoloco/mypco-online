...
<div class="overlay-menu" id="overlay-menu" aria-hidden="true">
	...
	<div class="overlay-menu__inner">
		...
		<?php if ( current_user_can( 'edit_theme_options' ) ) : ?>
			<a class="overlay-menu__customize" href="<?php echo esc_url( admin_url( 'customize.php?autofocus[panel]=simple_church_seasonal_panel' ) ); ?>">
				...
				<?php esc_html_e( 'Seasonal Styles', 'simple-church' ); ?>
			</a>
		<?php endif; ?>
	</div>
</div>
